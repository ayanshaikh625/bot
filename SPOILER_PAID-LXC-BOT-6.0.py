...
BOT_NAME = os.getenv('BOT_NAME', 'PheonixHost VM')
PREFIX = os.getenv('PREFIX', '!')
YOUR_SERVER_IP = os.getenv('YOUR_SERVER_IP', '127.0.0.1')
MAIN_ADMIN_ID = int(os.getenv('MAIN_ADMIN_ID', '1408851223834132564'))
VPS_USER_ROLE_ID = int(os.getenv('VPS_USER_ROLE_ID', '1408851223834132564'))
...
def create_embed(title, description="", color=0x1a1a1a):
    ...
    embed.set_thumbnail(url="https://cdn.discordapp.com/attachments/1438145287741767860/1473337574235045931/Gemini_Generated_Image_yd3bspyd3bspyd3b-removebg-preview.png?ex=6995d80a&is=6994868a&hm=b8442558a0206ab39819482d6771ef8d90222087892fe24767df95e63bafcb90&")
    embed.set_footer(text=f"{BOT_NAME} VPS Manager • {datetime.now().strftime('%Y-%m-%d %H:%M:%S')}",
                     icon_url="https://cdn.discordapp.com/attachments/1438145287741767860/1473337574235045931/Gemini_Generated_Image_yd3bspyd3bspyd3b-removebg-preview.png?ex=6995d80a&is=6994868a&hm=b8442558a0206ab39819482d6771ef8d90222087892fe24767df95e63bafcb90&")
    return embed
